-- COMPANYMANAGER — 162 PASS TEMPLATES POOL COUNTER FIX
-- Ujednolica licznik puli karnetów i wymusza odjęcie 1 sztuki po sprzedaży.
...
begin
  ...
  insert into public.sales(
    ...
    total_net, total_tax, total_gross, discount_value, payment_status,
    note, created_at, updated_at
  ) values (
    final_company_id, null, v_buyer_client_id, null, 'KARNET-' || to_char(now(), 'YYYYMMDDHH24MISS'),
    v_sale_price, 0, v_sale_price, 0, 'paid', v_description, now(), now()
  ...
  insert into public.passes(
    ...
    final_company_id, v_beneficiary_client_id, v_buyer_client_id, v_beneficiary_client_id, null,
