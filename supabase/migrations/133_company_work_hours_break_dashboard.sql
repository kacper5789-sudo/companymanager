-- COMPANYMANAGER 049B — company work hours + appointment break on Dashboard

alter table public.companies
add column if not exists appointment_break_minutes integer default 0;

update public.companies
set appointment_break_minutes = coalesce(appointment_break_minutes, 0),
    working_day_start = coalesce(working_day_start, '08:00'::time),
    working_day_end = coalesce(working_day_end, '20:00'::time),
    default_visit_duration_minutes = coalesce(default_visit_duration_minutes, 30);
