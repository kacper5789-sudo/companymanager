  ...
  function renderProgramSettings(company) {
    return `<section class="bm-page-card cm-program-settings-page" id="program-settings">
      ...
      <form class="bm-form-grid cm-company-panel-form" data-company-panel-form="program">
        ...
        <fieldset class="cm-notification-box"><legend>Grafik domyślny</legend>
          ${field("Początek dnia pracy", "working_day_start", val(company, "working_day_start") || "08:00", "time")}
          ${field("Koniec dnia pracy", "working_day_end", val(company, "working_day_end") || "18:00", "time")}
